...
int main()
{
	...
	inicializarListaEdificios(lista1); 
	inicializarListaJugadores(lista2); 

	cargarListaJugadores(lista2); 
	cargarListaEdificios(lista1);
	...
	while ( !abandonar)
	{
		if(strcmp(usuario, n_admin) == 0)
		{
			...
			do 
			{
				...
				switch(opcion)
				{
					case 0: //Salir del menu de administrador
							salir = true;
							salirJuego();
							break;
					case 1: //Muestra la lista de edificios
					...
					case 3:	//Borrar edificio
							...
							break;
					case 4: //Muestra la lista de jugadores
					...
					case 8: //Ver clasificacion(por dinero)
							...
							break;
					case 9: //Importar archivos
							importarArchivosTexto(lista1, lista2);
							break;
				}
			} while (!salir);
		}
		...
		else
		{
			...
			do 
			{
				...
				switch(opcion)
				{
					case 0: //Salir del menu de usuario
							salir = true;
							salirJuego();
							break;
					case 1: //Mis edificios
							misEdificios(lista1, lista2.tablaJugadores[posUsuario]);
							break;
					case 2: //Edificios disponibles
							ejecutarEdificiosDisponibles(lista1);
							break;
					case 3: //Comprar edificio
							ejecutarComprarEdificio(lista2.tablaJugadores[posUsuario], lista1);
							break;
	...
	delete [] lista1.tablaEdificio;
	delete [] lista2.tablaJugadores;
...
void clasificacionPorDinero(tListaJugadores lista)
{
	...
	{
		listaAux[b] = lista.tablaJugadores[b];
	}
	bool inter = true;
	int i = 0, aux;
