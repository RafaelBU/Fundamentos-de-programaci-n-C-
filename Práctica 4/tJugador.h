...
//Lee los datos de un jugador, inicializa su lista de edificios comprados como vacía, el dinero a 3.000 créditos y los puntos de prestigio a 0.
//Devuelve la estructura tJugador debidamente inicializada
tJugador nuevoJugador();

//Dado un tJugador y la lista de edificios, muestra en la consola los datos del jugador 
//y los datos básicos de todos sus edificios (nombre, dinero y prestigio por turno).
...
//Muestra los edificios del jugador que tiene iniciada la sesion
